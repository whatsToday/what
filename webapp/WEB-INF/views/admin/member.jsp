...
<link href="/assets/admin/css/fancybox/jquery.fancybox.css"
	rel="stylesheet">
	...
	<div id="wrapper">
		...
		<section id="featured">
						...
						<table class="CSSTableGenerator">
							...
							<c:forEach var="vo" items="${memberList}">
								...
								고객의 사진이 없습니다.								
									...
									<td><a
										href="/admin/deletemember?member_no=${vo.member_no }">삭제</a></td>
								</tr>
							</c:forEach>
						</table>
         ...
         [이전]&nbsp;
									...
									</c:forEach> <c:if test="${nowpage>=maxpage}">
           [다음]&nbsp;
      </c:if> <c:if test="${nowpage<maxpage}">
